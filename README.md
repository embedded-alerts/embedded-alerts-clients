# embedded-alerts-clients (superseded)

> This repository is frozen. The canonical source of truth is [`eal-clients`](https://github.com/embedded-alerts/eal-clients).
...
- Open issues, pull requests, releases, and new work in `embedded-alerts/eal-clients`.
- Change Zed dependencies to `"embedded-alerts/eal-clients" = "^0.1.0"`.
- Point any retained submodule at `embedded-alerts/eal-clients` and classify it according to the canonical monorepo's composition policy.
