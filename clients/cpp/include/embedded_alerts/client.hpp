...
#include <string>
#include <utility>
namespace embedded_alerts {
class EmbeddedAlertsClient final {
 public:
  explicit EmbeddedAlertsClient(std::string base_url, std::optional<std::string> bearer_token = std::nullopt)
